#BSUB -W 48:00
#BSUB -n 1
#BSUB -e /home/levinej4/bsub_logs/maester_filter_%I_%J.err
#BSUB -o /home/levinej4/bsub_logs/maester_filter_%I_%J.out
...
wd="/data/lareauc/levinej/mito_working_directory/smack_notebooks/maester/maester_${i}"
hdir="${wd}/h5_files"
