...
wd="/data/lareauc/levinej/mito_working_directory/smack_notebooks/tf1/tf1_mtscatac_${i}_quality_based"
hdir="${wd}/h5_files"
...
smack -wd $wd --debug genotype $BAM $hdir -bf $BC --genome hg38 --barcode-tag CB --sample-id $i -s MEAN_QUALITY